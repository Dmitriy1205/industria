...
abstract class AdminEmployeeService{
  ...
  Future<TableData<List<Employee>>> listEmployees({required int page, required int elementsPerPage, required String searchTerm});
