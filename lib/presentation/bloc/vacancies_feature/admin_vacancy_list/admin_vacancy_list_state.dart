...
class AdminVacancyListState with _$AdminVacancyListState {
  ...
  TableData<List<Vacancy>> get tableData => maybeMap(
  ...
  const factory AdminVacancyListState.loaded({required TableData<List<Vacancy>> tableData, required String searchTerm}) = _LoadedState;
}
