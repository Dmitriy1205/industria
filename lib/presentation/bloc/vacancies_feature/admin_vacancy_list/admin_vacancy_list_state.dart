...
class AdminVacancyListState with _$AdminVacancyListState {
  ...
  TableData<List<JobOffer>> get tableData => maybeMap(
  ...
  const factory AdminVacancyListState.loaded({required TableData<List<JobOffer>> tableData, required String searchTerm}) = _LoadedState;
}
