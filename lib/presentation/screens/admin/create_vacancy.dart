...
class CreateVacancy extends StatefulWidget {
  const CreateVacancy({Key? key}) : super(key: key);
...
class _CreateVacancyState extends State<CreateVacancy> {
  JobTypes dropdownJobType = JobTypes.values.first;
  JobAreas dropdownJobArea = JobAreas.elements.first;
  Period dropdownPeriod = Period.year;
  Currency dropdownCurrency = Currency.euro;
  ...
  final _adminCreateVacancyBloc = AdminCreateVacancyBloc(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CompaniesCubit, List<Company>?>(
      bloc: _companiesCubit,
      builder: (context, state) => state == null
          ? Center(
              child: CircularProgressIndicator(),
            )
          : BlocListener<AdminCreateVacancyBloc, AdminCreateVacancyState>(
              bloc: _adminCreateVacancyBloc,
