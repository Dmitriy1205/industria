...
class ViewJobApplication extends StatefulWidget {
  const ViewJobApplication({Key? key}) : super(key: key);
...
class _ViewJobApplicationState extends State<ViewJobApplication> {
  final _viewJobApplicationBloc = ViewJobApplicationBloc(
      jobApplicationRepository: sl<JobApplicationRepository>());
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (paramValue != null) {
        _viewJobApplicationBloc.add(
            ViewJobApplicationEvent.fetchJobApplicationById(id: paramValue));
      }
    });
  }
    ...
    return BlocConsumer<ViewJobApplicationBloc, ViewJobApplicationState>(
      listener: (context, state) {
        state.maybeMap(
            ...
            changedStatus: (state) {
              context.read<AdminJobApplicationsBloc>().add(
                  AdminJobApplicationsEvent.replaceJobApplication(
                        ...
                        children: [
                          MouseRegion(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                router.go('/admin/job_applications');
                              },
                              child: const Icon(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    _section(
                                        title: AppLocalizations.of(context)!
                                            .firstname,
                                        subtitle:
                                            state.jobApplication!.firstname),
                                    _section(
                                        title: AppLocalizations.of(context)!
                                            .lastname,
                                        subtitle:
                                            state.jobApplication!.lastname),
                                    _section(
                                        title: AppLocalizations.of(context)!
                                            .dateOfBirth,
                                        subtitle: state.jobApplication!.birthday
                                            .formatted),
                                  ],
                                ),
                                const SizedBox(
                                  ...
                                  children: [
                                    _section(
                                        title: AppLocalizations.of(context)!
                                            .citizenship,
                                        subtitle:
                                            state.jobApplication!.citizenship),
                                    _section(
                                        title: AppLocalizations.of(context)!
                                            .availabilityDate,
                                        subtitle: state.jobApplication!
                                            .availableDate.formatted),
                                    _section(
                                        title: AppLocalizations.of(context)!
                                            .gender,
                                        subtitle: state.jobApplication!.gender),
                                  ],
                                ),
                                const SizedBox(
                                  height: 30,
                                ...
                                _section(
                                    ...
                                    subtitle: state.jobApplication!.address),
                                const SizedBox(
                                  height: 30,
                                ),
                                state.jobApplication!.questionAnswers.isEmpty
                                    ? SizedBox.shrink()
                                    : Text(
                            ...
                            child: Row(
                              ...
                              children: [
                                _section(
                                    ...
                                    subtitle:
                                        state.jobApplication!.jobOfferName,
                                    link: true),
                                const SizedBox(
                                  width: 65,
                                ),
                                _section(
                                    ...
                                    subtitle:
                                        state.jobApplication!.company.name,
                                    link: true),
                                const Spacer(),
                                Text(
                                  state.jobApplication!.createdAt
                                      .formattedTextedWithTime(context
                    ...
                    children: [
                      ...
                      SizedBox(
                          ...
                          child: AppElevatedButton(
                            onPressed: () {
                              _viewJobApplicationBloc.add(
                                  ViewJobApplicationEvent.changeStatus(
                                      id: state.jobApplication!.id,
