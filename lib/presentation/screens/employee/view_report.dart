...
// late HolidayRequest paramValue;
//   @override
//   void initState() {
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       paramValue = routeValue(context, "report") as HolidayRequest;
...
class ViewReport extends StatefulWidget {
  final HolidayRequest paramValue;

  ViewReport({Key? key, required this.paramValue}) : super(key: key);
